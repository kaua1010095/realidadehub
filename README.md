...
local Window = OrionLib:MakeWindow({Name = "Realidade hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Realidade hub"})
...
W:AddLabel("[+] Realidade hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Realidade hub(Noitification)",
